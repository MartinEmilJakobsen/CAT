                          ...
                          intervMat = NA) 
{
    ...
    computeScoreMatForOutput <- computeScoreMatTmp
    ...
    result <- list(Adj = Adj, Score = sum(scoreNodes), timesVec = c(timeSel, timeScoreMat, timeCycle, timeUpdate, timePrune, timeMax, timeTotal), scoreVec = scoreVec, edgeList = edgeList, ScoreMat = computeScoreMatForOutput)
    return(result)  
}
